...
async function bootstrap() {
  const [customers, loads, locations, drivers, trucks, invoices, settlements, recurringRules, complianceEvents] = await Promise.all([
    listRows('customers'),
    listRows('loads'),
    listRows('locations'),
    listRows('drivers'),
    listRows('trucks'),
    listRows('invoices'),
    listRows('settlements'),
    listRows('recurring-rules'),
    listRows('compliance'),
  ]);
  return { customers, loads, locations, drivers, trucks, invoices, settlements, recurringRules, complianceEvents };
}
