      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-orange hover:bg-orange/90 text-white px-5 py-2 rounded-lg shadow-sm font-bold transition-all transform active:scale-95 text-xs"
          >
            <Plus size={15} /> Create New Load
          </button>
        </div>
      </div>
