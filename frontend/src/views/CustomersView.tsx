...
export default function CustomersView() {
  ...
  React.useEffect(() => {
    if (navigationIntent && navigationIntent.view === 'customers' && navigationIntent.action === 'create') {
  ...
  React.useEffect(() => {
    setUnsavedChanges(showCreationMode || isEditing);
  }, [showCreationMode, isEditing, setUnsavedChanges]);
