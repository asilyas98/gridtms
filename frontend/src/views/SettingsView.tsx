          ...
          {activeTab === 'Company' && (
            <form onSubmit={handleSaveCompany} className="divide-y divide-slate-100">
              <div className="p-6 bg-slate-50/50 flex items-center justify-between">
                ...
                <button 
                  type="submit" 
                  className="px-4 py-2 bg-orange hover:bg-orange/90 active:scale-95 text-white font-mono text-[10px] font-black uppercase tracking-widest rounded-lg transition-all"
                >
                  Save Identity
                </button>
              </div>
