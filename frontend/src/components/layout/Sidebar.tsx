    ...
    <div className="w-full h-full relative select-none">
      ...
      >
        ...
        <div className="flex-1 px-3 overflow-y-auto no-scrollbar py-2 space-y-0.5">
          ...
          {!collapsed && (
            <div className="px-3 py-1.5 mb-1 mt-4 select-none">
              <p className="text-[9px] text-slate-400 dark:text-zinc-500 uppercase tracking-widest font-bold">System</p>
            </div>
          )}
          <SidebarItem
            icon={FolderOpen}
          ...
          <SidebarItem
            ...
            num={unreadNotificationCount > 0 ? String(unreadNotificationCount) : undefined}
            collapsed={collapsed}
          />
        ...
        <div className="p-3 mt-auto border-t border-[#E5E5EA] dark:border-[#1C1C1E] bg-[#F5F5F7] dark:bg-black/40 flex overflow-hidden">
          <div className="flex items-center w-full px-1">
            ...
            >
              ...
              <button title="Log Out" className="text-slate-400 hover:text-red-500 transition-colors flex-shrink-0 ml-1 cursor-pointer">
                <LogOut size={14} />
              </button>
            </motion.div>
          </div>
