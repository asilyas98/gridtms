...
import { X, FileText, Send, Save, CreditCard, Building, Paperclip, CheckSquare, Plus, Trash2, Printer, Download, CheckCircle2, Circle, Eye, Upload, Mail } from 'lucide-react';
